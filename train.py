...
tf.flags.DEFINE_string("positive_data_file", "./suggestion.txt", "Data source for the suggestion data.")
tf.flags.DEFINE_string("negative_data_file", "./non_suggestion.txt", "Data source for the non suggestion data.")
